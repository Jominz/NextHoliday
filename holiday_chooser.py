...
places = ['Afghanistan', 'Albania', 'Algeria', 'Andorra', 'Angola', 'Antigua and Barbuda', 'Argentina',
          ...
          'Saint Vincent and the Grenade', 'Samoa', 'San Marino', 'Sao Tome and Principe', 'Saudi Arabia', 'Senegal',
...
print("Here your next holiday's destination:\n")
print("You will have a great time in the " + random_zone + ' part of \033[33m' + random_place)
